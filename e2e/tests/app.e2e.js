...
test.describe('AngularJS-Material-Vite app', () => {
    ...
    test.describe('Home', () => {
        test('HomePage content', async ({ page }) => {
            ...
            await expect(homePage.heroImage).toHaveAttribute('src', 'https://res.cloudinary.com/fyodorio/image/upload/v1611994660/my-logos/hotrod-logo_rhkfxy.jpg');
        ...
        test('Redirect to Angular Material page', async ({page}) => {
            ...
            await expect(page.url()).toContain('angularjs.org');
        });
    })
